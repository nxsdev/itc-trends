...
const fieldStyles = tv({
  slots: {
    ...
    label:
      "inline-flex items-center gap-px font-medium text-xs leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-50 [&_svg]:size-3",
    description: "text-foreground-muted text-xs",
    fieldError: "text-destructive text-xs",
  },
})
